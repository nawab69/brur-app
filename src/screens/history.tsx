        ...
        <View className="mt-8">
            ...
            */}
            <View className=" border-black/10 py-3">
                ...
                <Text className="text-black text-xl mx-auto font-['Inter-Medium'] capitilize">History</Text>
            </View>
            {/* 
                    Trades
            */}
    ...
    return (<TouchableOpacity key={index} className="flex-row gap-x-2 my-2" onPress={onPress}>
        <View className="flex-1 flex-row justify-between bg-[#F9F9FF] p-1 rounded-xl">
            <View className="space-y-2 p-2 rounded-xl">
                <View className="bg-slate-300 rounded-lg w-18 py-0.5 px-2 mx-auto"><Text className="font-['Inter-SemiBold'] uppercase text-xs text-main">bKash</Text></View>
                <Text className="font-['Inter-SemiBold'] text-lg text-main"> &#2547; {trade?.amount}</Text>
                <Text className="font-['Inter-Medium'] text-xs text-slate-300">12 - 03 - 2020</Text>
            </View>
            <View className="flex items-end p-3 space-y-2">
                <Text>AID: {trade?.aid}</Text>
                <Text className="font-['Inter-SemiBold'] text-lg text-main">{trade?.status}</Text>
            </View>
        </View>
    </TouchableOpacity>)
}