                    ...
                    {/* <TouchableOpacity key={"twa"} className="my-3" onPress={() => setIsTwa(true)}>
                        <View className='flex-row justify-between items-center'>
                            <View className='flex-row gap-x-6'>
                                ...
                                <Text className="text-black text-lg font-['Inter-Medium'] mx-auto">Two factor authentication</Text>
                            </View>
                    ...
                    <TouchableOpacity key={"logout"} className="my-5" onPress={_logout}>
                        <View className='flex-row justify-between items-center'>
                            <View className='flex-row gap-x-6'>
                                ...
                                <Text className="text-black text-lg font-['Inter-Medium'] mx-auto">Logout</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
        ...
        <TouchableOpacity key={index} className="my-3" onPress={() => toggle(card.title)}>
            <View className='flex-row justify-between items-center'>
                <View className='flex-row gap-x-6'>
                    ...
                    <Text className="text-black text-lg font-['Inter-Medium'] mx-auto">{card.title}</Text>
                </View>
