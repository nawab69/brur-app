...
export const ChangePassword = () => {
    ...
    return (
        <View>
            <Text className="font-['Inter-Medium'] text-main text-[18px] capitalize -mt-4 pb-3 mb-4 text-center border-b border-slate-300">Change password</Text>
            <Formik
                ...
                {({ handleChange, handleBlur, handleSubmit, values, errors }) => (
                    <KeyboardAvoidingView className="space-y-0">
                        <View className="group flex items-start">
                            <Text className="group-focus:-translate-y-5 font-['Inter-Medium'] text-black text-xs bg-white translate-y-2 translate-x-7 z-10 px-2">New password</Text>
                            ...
                            <Text className="font-['Inter-Medium'] text-red-500 text-xs bg-white px-2">{errors.newPass}</Text>
                        </View>
                        <View className="group flex items-start">
                            <Text className="group-focus:-translate-y-5 font-['Inter-Medium'] text-black text-xs bg-white translate-y-2 translate-x-7 z-10 px-2">Confirm password</Text>
                            <View className="w-full">
                                <TextInput
                                    className="rounded-lg border-2 border-[#4A3FBC] h-14 px-4 w-full text-black font-['Inter-SemiBold'] text-sm"
                                    secureTextEntry={secure}
                            ...
                            <Text className="font-['Inter-Medium'] text-red-500 text-xs bg-white px-2">{errors.confirmPass}</Text>
                        </View>
                        <View className="group flex items-start">
                            <Text className="group-focus:-translate-y-5 font-['Inter-Medium'] text-black text-xs bg-white translate-y-2 translate-x-7 z-10 px-2">Current password</Text>
                            <View className="w-full">
                                <TextInput
                                    className="rounded-lg border-2 border-[#4A3FBC] h-14 px-4 w-full text-black font-['Inter-SemiBold'] text-sm"
                                    secureTextEntry={secure}
                            ...
                            <Text className="font-['Inter-Medium'] text-red-500 text-xs bg-white px-2">{errors.currPass}</Text>
                        </View>
