...
export function FormFillUp({ close }: { close?: any }) {
    ...
    return (
        <KeyboardAvoidingView>
            <Text className="font-['Inter-Medium'] text-main text-[18px] capitalize -mt-4 pb-3 mb-4 text-center border-b border-slate-300">Form Fill Up</Text>
            ...
            <View className="space-y-0">
...

                {
                    type === FormFillUpType.Improvement && (
                        <View className="space-y-0">
                            <Text className="font-['Inter-Medium'] text-main text-[18px] capitalize mt-4 pb-3 mb-4 text-center border-b border-slate-300">Improvement Course Details</Text>
                                ...
                                isNewCourse ? (
                                    <View>
                                        ...
                                        <View className="flex items-start">
                                            <Text className="font-['Inter-Medium'] text-black text-xs bg-white translate-y-2 translate-x-7 z-10 px-2">Course Code</Text>
                                            <TextInput className="rounded-lg border-2 border-[#4A3FBC]/20 h-12 px-4 w-full text-black font-['Inter-SemiBold'] text-sm" value={currentCourse.code} onChangeText={(value) => setCurrentCourse({ ...currentCourse, code: value })} />
                                        </View>
                                        <View className="flex items-start">
                                            <Text className="font-['Inter-Medium'] text-black text-xs bg-white translate-y-2 translate-x-7 z-10 px-2">Course Title</Text>
                                            <TextInput className="rounded-lg border-2 border-[#4A3FBC]/20 h-12 px-4 w-full text-black font-['Inter-SemiBold'] text-sm" value={currentCourse.title} onChangeText={(value) => setCurrentCourse({ ...currentCourse, title: value })} />
                                        </View>
                                        ...
                                        <View className="flex items-start">
                                            <Text className="font-['Inter-Medium'] text-black text-xs bg-white translate-y-2 translate-x-7 z-10 px-2">Previous GPA</Text>
                                            <TextInput className="rounded-lg border-2 border-[#4A3FBC]/20 h-12 px-4 w-full text-black font-['Inter-SemiBold'] text-sm" value={currentCourse.previousGPA} onChangeText={(value) => setCurrentCourse({ ...currentCourse, previousGPA: value })} keyboardType="number-pad" />
                                        </View>
